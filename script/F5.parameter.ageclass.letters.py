...
add_label_at_errorbar(axes[0], x, native_m, native_se, x_value=4, text="bc", where="below")
...
add_label_at_errorbar(axes[1], x, perennial_m, perennial_se, x_value=4,  text="bc", where="above")
